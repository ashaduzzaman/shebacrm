	    	...
	    	<div class="col-md-8 col-sm-offset-2">
	        	<div class="box box-success">
	            	<div class="box-header with-border">
	                	<h3 class="box-title"> CRM Report In Excel</h3> 
	            	</div>
	            	<div class="box-body">
	            		...
	            		<div class="col-sm-12">
							...
							<div class="card">
								<div class="card-header">
									<h3 class="text-center"><i class="fa fa-pencil"></i> <code><b>CRM</b></code> Report In Excel </h3>
								</div>
								<div class="card-body">
							  		
									
	                                {!! Form::open(['url' => 'report/crm-show-excel', 'method' => 'post', 'class' => 'form-horizontal']) !!}

	                                <div class="form-group {{ $errors->has('start_date') ? 'has-error' : ''}}">
	                                    {!! Form::label('start_date', 'Start Date', ['class' => 'required col-3 col-sm-3 control-label']) !!}
	                                    <div class="col-xs-9 col-sm-9">
	                                        {!! Form::text('start_date', null, ['class' => 'form-control', 'placeholder' => 'Select Start Date', 'autocomplete' => 'off', 'id' => 'start_date', 'required' => 'required', 'readonly' => 'readonly']) !!}
	                                ...
	                                <div class="form-group {{ $errors->has('end_date') ? 'has-error' : ''}}">
	                                    ...
	                                    <div class="col-xs-9 col-sm-9">
	                                        {!! Form::text('end_date', null, ['class' => 'form-control', 'placeholder' => 'Select Start Date', 'autocomplete' => 'off', 'id' => 'end_date', 'required' => 'required', 'readonly' => 'readonly']) !!}
	                                        <span class="text-danger">
