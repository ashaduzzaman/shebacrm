        	...
        	<div class="col-md-8 col-sm-offset-2">
            	<div class="box box-success">
                	<div class="box-header with-border">
                    	<h3 class="box-title">CRM Report Form</h3> 
                	</div>
                	<div class="box-body">
                		...
                		<div class="col-sm-12">
    						...
    						<div class="card">
    							<div class="card-header">
    								<h3 class="text-center"><i class="fa fa-chart-bar"></i> <code><b>CRM</b></code> Report Form</h3>
    							</div>
    							<div class="card-body">
    						  		
    								
                                    {!! Form::open(['url' => 'report/crm-show', 'method' => 'get', 'class' => 'form-horizontal']) !!}
